<template>
  <Transition name="sidebar">
    <aside
      class="sidebar fixed w-[280px] top-0 right-0 h-full bg-gray-100 py-3"
    >
      <div
        class="sidebar__actions flex justify-end items-center gap-4 mb-4 pr-4"
      >
        ...
        <div class="sidebar__close" @click="showHideSidebar">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
            fill="none"
      ...
      <div class="sidebar__nav mb-12">
        <p class="font-bold w-full px-4 pt-4 pb-2.5 selected">Dashboard</p>
        <p class="font-bold w-full px-4 pt-4 pb-2.5">Influencers</p>
      </div>
      <div class="sidebar__auth px-4">
        <AuthBtn class="w-full" />
      </div>
    </aside>
  </Transition>
</template>
